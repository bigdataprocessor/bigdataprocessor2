...
import de.embl.cba.bigDataToolViewerIL2.boundingBox.BoundingBox;
import de.embl.cba.bigDataToolViewerIL2.boundingBox.SetupBoundingBox;
...
import de.embl.cba.bigDataToolViewerIL2.saving.SavingSettings;
...
public class TestBoundingBoxCropAndSave {
    ...
    public static void main(String[] args)
    {
        ...
        final BoundingBoxDialog boundingBoxDialogCopy =
                new BoundingBoxDialog( frame, "bounding box", bdvStackSource.getBdvHandle().getViewerPanel(),  bdvStackSource.getBdvHandle().getSetupAssignments(), boxSetupId, initialInterval, rangeInterval )
                {
                    @Override
        ...
        savingSettings.fileType = FileInfoConstants.FileType.HDF5_IMARIS_BDV;
