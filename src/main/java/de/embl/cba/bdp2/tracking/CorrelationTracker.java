...
public class CorrelationTracker< T extends RealType<T> & NativeType< T > > extends AbstractObjectTracker{
    ...
    public CorrelationTracker( TrackingSettings< T > trackingSettings, AtomicBoolean stop ) {
