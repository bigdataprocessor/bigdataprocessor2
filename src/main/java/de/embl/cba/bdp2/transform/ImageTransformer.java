...
import de.embl.cba.bdp2.devel.Rai5DShearer;
...
public class ImageTransformer < R extends RealType< R > & NativeType< R > >
{
	...
	public Image transform()
	{
		...
		for (int t = 0; t < numTimePoints; ++t)
		{
			...
			Rai5DShearer task = new Rai5DShearer( raiXYZCT, t, transform3D, interpolatorFactory );
			task.fork();
			tasks.add(task);
		}
		...
		final RandomAccessibleInterval< R > transformedXYZCT = Views.stack( timePoints );
