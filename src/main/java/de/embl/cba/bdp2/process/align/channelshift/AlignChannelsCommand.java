...
@Plugin(type = AbstractImageProcessingCommand.class, name = AlignChannelsCommand.COMMAND_NAME, menuPath = de.embl.cba.bdp2.dialog.Utils.BIGDATAPROCESSOR2_COMMANDS_MENU_ROOT + AbstractImageProcessingCommand.COMMAND_PROCESS_PATH + AlignChannelsCommand.COMMAND_FULL_NAME )
