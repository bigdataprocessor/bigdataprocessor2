...
public class BigDataConverter {
    ...
    public static void saveImage( SavingSettings savingSettings, ImageViewer imageViewer ) { //TODO: No need to getDownsampledView imageVieweer.Use only SavinfgSetting
