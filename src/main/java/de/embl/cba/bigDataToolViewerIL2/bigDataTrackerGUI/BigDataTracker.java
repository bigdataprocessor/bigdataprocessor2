package de.embl.cba.bigDataToolViewerIL2.bigDataTrackerGUI;

import bdv.util.*;
import de.embl.cba.bigDataToolViewerIL2.dataStreamingGUI.BdvMenus;
import de.embl.cba.bigDataToolViewerIL2.dataStreamingGUI.DataStreamingTools;
import de.embl.cba.bigDataToolViewerIL2.dataStreamingGUI.DisplaySettings;
...
import de.embl.cba.bigDataToolViewerIL2.viewers.BdvImageViewer;
import de.embl.cba.bigDataToolViewerIL2.viewers.ImageViewer;
...
public class BigDataTracker {
    ...
    public void kickOffThreadPack(int nIOthreads){
        if(null == DataStreamingTools.trackerThreadPool ||  DataStreamingTools.trackerThreadPool.isTerminated()){
            DataStreamingTools.trackerThreadPool = Executors.newFixedThreadPool(nIOthreads);
        }
    }

    public void shutdownThreadPack(){
        Utils.shutdownThreadPack(DataStreamingTools.trackerThreadPool,5);
    }
