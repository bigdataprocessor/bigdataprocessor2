...
public class PhaseCorrelationPeak {
	 ...
	 * @param phaseCorr
	 */
	public PhaseCorrelationPeak(Localizable pcmPosition, double phaseCorr) {
	 ...
	 * @param src
	 */
	public PhaseCorrelationPeak(PhaseCorrelationPeak src) {
	...
	public static class ComparatorByPhaseCorrelation implements Comparator<PhaseCorrelationPeak> {
		@Override
		public int compare(PhaseCorrelationPeak o1, PhaseCorrelationPeak o2) {
			return Double.compare(o1.phaseCorr, o2.phaseCorr);
		}
	}

	public static class ComparatorByCrossCorrelation implements Comparator<PhaseCorrelationPeak> {
		@Override
		public int compare(PhaseCorrelationPeak o1, PhaseCorrelationPeak o2) {
